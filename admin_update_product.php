...
if(isset($_POST['update_product'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         $message[] = 'kích thước file hình ảnh quá lớn!';
      }else{
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price']; ?>" required placeholder="cập nhật giá sản phẩm (VNĐ)" name="price">
